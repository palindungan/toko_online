<div class="shop-products-wrapper">
    <div class="tab-content">
                                ...
                                <div class="product_desc_info">
                                    <div class="product-review">
                                        <h5 class="manufacturer">
                                            <a href="#detail_produk2">Graphic Corner</a>
                                        </h5>
                                    ...
                                    <h4><a class="product_name" href="#detail_produk">Nama Produk Kami</a></h4>
                                    <div class="price-box">
                                        <span class="new-price">Rp 1.000.000,00</span>
                                    </div>
                                </div>
                                <div class="add-actions">
                                    <ul class="add-actions-link">
                                        <li class="add-cart active"><a href="#keranjang">Beli Barang</a></li>
        ...
        <!-- Pagination Start -->
        <?php $this->load->view("view_tamu/konten/katalog/_partials/pagination.php") ?>
        <!-- Pagination End -->
